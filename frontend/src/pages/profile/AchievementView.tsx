      ...
      <div className="mb-8">
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'earned'
              ? 'bg-purple-600 text-white'
              : 'bg-gray-800 text-gray-300 hover:bg-gray-700'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-colors ${filter === 'unearned'
              ? 'bg-purple-600 text-white'
              : 'bg-gray-800 text-gray-300 hover:bg-gray-700'
              }`}
          >
                ...
                .map((achievement) => {
                  ...
                  return (
                    <div
                      ...
                      className={`border-2 rounded-lg p-4 transition-all relative ${isEarned
